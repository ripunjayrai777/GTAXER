  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-white shadow-md z-50">
      <nav className="container mx-auto flex justify-between items-center px-6 py-4">
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <ul className="absolute top-16 right-6 bg-white shadow-lg rounded-lg p-4 space-y-3 md:hidden">
            <li><a href="#home" className="block hover:text-blue-600">Home</a></li>
            <li><a href="#services" className="block hover:text-blue-600">Services</a></li>
            <li><a href="#portfolio" className="block hover:text-blue-600">Portfolio</a></li>
            ...
            <li><a href="#testimonials" className="block hover:text-blue-600">Testimonials</a></li>
          </ul>
        )}
      </nav>
    </header>
